  ...
  <div class="page-sidebar" id="main-menu">
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
      <div class="user-info-wrapper">
        <div class="profile-wrapper"> <img src="assets/img/others/images1.png"  alt="" data-src="assets/img/others/images1.png" data-src-retina="assets/img/others/images1.png" width="69" height="69" /> </div>
        <div class="user-info">
